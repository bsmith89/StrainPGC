...
- Disk (Between 160 and 200 GB)
    ...
    - Intermediate files generated by the workflow totaled > 70 GB. Some of
      ...
      their purpose. (They're marked with `temp(...)` in the Snakefile.
      However, note that the provided Snakemake profiles all include the
      `--notemp` flag for testing purposes.)
